...
case 'allmenu':
case 'llmenu':
menu = `TEXTO DE EL MENU`
cnf.sendMessage(from, menu, text, { quoted: ftrol, thumbnail: fs.readFileSync('./confumods.jpg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Bot By Matt`,body:"",mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtube.com/c/ConfuMods`}}})
break
